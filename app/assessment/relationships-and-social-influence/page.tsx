...
export default function QuestionnairePage4() {
  // --- State for Answers ---
  const [qn32, setQn32] = useState<string>("");
  const [qn34, setQn34] = useState<string>("");
  const [qn35, setQn35] = useState<string>("");
  const [qn37, setQn37] = useState<string>("");
  const [qn38, setQn38] = useState<string>("");
      ...
      <nav className="w-full bg-white border-b border-[#DDE4EA] h-[56px] md:h-[64px] flex items-center px-6 sticky top-0 z-40">
        <div className="max-w-[1200px] mx-auto w-full flex justify-between items-center">
          <div className="flex flex-col w-[120px] cursor-pointer">
            <span className="text-[#1B9DC8] font-bold text-lg leading-none">
              HSH
            </span>
      ...
      <section className="w-full bg-white px-6 py-4 border-b border-[#DDE4EA]">
        <div className="max-w-[680px] mx-auto w-full">
          <div className="flex justify-between items-end mb-2">
            <span className="font-medium text-[13px] text-[#5A6473]">
              Step 4 of 6
            </span>
      ...
      <section className="w-full bg-white px-5 md:px-6 pt-8 pb-5 rounded-b-[24px] shadow-[0_4px_12px_rgba(0,0,0,0.02)]">
        <div className="max-w-[680px] mx-auto flex flex-col items-center text-center">
          ...
          <p className="font-normal text-[16px] text-[#5A6473] max-w-[420px] leading-[1.6]">
            Tell us about the people and influences around you in your daily life.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-[680px] mx-auto flex flex-col gap-4">
          ...
          >
            ...
            <h2 className="font-semibold text-[16px] text-[#1A1A2E] mb-4 leading-snug">
              Are you aware of the risks associated with dating much older individuals (sugar daddies)?
            </h2>
            {renderChips(optionsQ1, qn32, setQn32, 1)}
          </div>
          ...
          >
            ...
            <h2 className="font-semibold text-[16px] text-[#1A1A2E] mb-4 leading-snug">
              Do you have friends or peers who engage in risky behaviors?
            </h2>
            {renderChips(optionsQ2, qn34, setQn34, 2)}
          </div>
          ...
          >
            ...
            {/* Contextual Note Treatment */}
            <div className="border-l-2 border-[#DDE4EA] pl-2.5 mb-2.5">
              <span className="italic text-[13px] text-[#5A6473]">
                Thinking about the friends or peers you mentioned above...
              </span>
            </div>

            <h2 className="font-semibold text-[16px] text-[#1A1A2E] mb-4 leading-snug">
              How does this influence your own choices?
            </h2>
            {renderChips(optionsQ3, qn35, setQn35, 3)}
          </div>
          ...
          >
            ...
            <h2 className="font-semibold text-[16px] text-[#1A1A2E] mb-4 leading-snug">
              What is your view on pregnancy while young?
            </h2>
            {renderRadioList(optionsQ4, qn37, setQn37, 4)}
          </div>
          ...
          >
            ...
            <h2 className="font-semibold text-[16px] text-[#1A1A2E] mb-4 leading-snug">
              Has a friend in your age group got pregnant before?
            </h2>
            {renderChips(optionsQ5, qn38, setQn38, 5)}

            {/* Discreet Branching Note */}
            <div className="flex items-center gap-2 mt-3 text-[#5A6473]">
              <InfoIcon className="text-[#5A6473] shrink-0" />
              <span className="font-normal text-[12px]">
                Your answer helps us understand your social environment.
              </span>
            </div>
          </div>

          {/* 5. ENCOURAGEMENT STRIP */}
          <div className="w-full mt-2 rounded-[12px] bg-[#E8F8F2] border border-[#A8DFC8] p-[14px_18px] flex items-center gap-3 shadow-sm">
            <CheckCircleIcon className="text-[#2EAF7D] shrink-0" />
            <span className="font-semibold text-[13px] text-[#1A1A2E]">
              Almost there — just 2 more sections after this.
            </span>
          </div>
        </div>
      </section>
        ...
        <div className="w-full bg-white h-[72px] px-6 border-t border-[#DDE4EA] shadow-[0_-2px_12px_rgba(0,0,0,0.06)] flex items-center justify-between">
          <div className="max-w-[1200px] mx-auto w-full flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="w-5 h-2 rounded-full bg-[#1B9DC8]"></div> {/* Step 4: Active */}
              <div className="w-2 h-2 rounded-full bg-[#DDE4EA]"></div> {/* Step 5 */}
